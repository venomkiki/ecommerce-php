...
<form action="<?php echo $paypal_url;?>/cgi-bin/webscr" method="post" name="buyCredits" id="buyCredits">
    ...
    <input type="hidden" name="business" value="clintonfungai@gmail.com">
    ...
    <input type="hidden" name="return" value="http://localhost/buymore1/userpanel/paymentsuccess.php?id=<?php echo $order_id; ?>">
</form>
<script type="text/javascript">
