    ...
    <div class="container">
        ...
        <div class="table-responsive cart_info">
            <table class="table table-condensed">
                ...
                if($d==0)
                {
                    echo "<h3>"; echo "no item is currently inside the cart"; echo "</h3>";
                    echo "<br>";
                }
                else
                    {
                ...
                foreach ($_COOKIE['item'] as $name1 => $value)   //this is for looping as per cookies if 3 cookies then loop move
                {
                    ...
                    <tr>
                        <td class="cart_product">
                            <a href=""><img src="../admin/<?php echo $values11[0];?>" height="150" width="180" alt=""></a>
                        </td>
                ...
                ?>
                    ...
                    if (isset($_COOKIE['item']))  //this is for chec cookies are available or nor
                    {
                        ...
                        echo "<p class='cart_total_price' style='align-content: right'; align='center'>";
                        echo "Total Cost: $ ";
                        echo $tot;
                        echo "</p>";
                        $_SESSION["pay"] = $tot;
...
<center><a href="checkout.php"> <input type="button" name="button" class="button" value="Check out"/> </a>
</center>
<br>
